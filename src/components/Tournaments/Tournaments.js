    ...
    <div className={ styles.tournaments }>
      ...
      <div className={ styles.result }>
        ...
        <div className={ styles.game }>
          <div className={ styles.team1 } title="Alash">Alash</div>
            <div className={ styles.score }>
              <span style={{ color: '#613CEA' }}>3</span>:<span style={{ color: '#000' }}>2</span>
            </div>
          <div className={ styles.team2 } title="Nurtas">Nurtas</div>
        </div>
        <div className={ styles.game }>
          <div className={ styles.team1 } title="Allur Qostanai">Allur Qostanai</div>
            <div className={ styles.score }>
              <span style={{ color: '#000' }}>1</span>:<span style={{ color: '#613CEA' }}>2</span>
            </div>
          <div className={ styles.team2 } title="QURMAN">QURMAN</div>
        </div>
        <div className={ styles.game }>
          <div className={ styles.team1 } title="Alash">Alash</div>
            <div className={ styles.score }>
          ...
          <div className={ styles.team2 } title="Казахтелеком">Казахтелеком</div>
        </div>
        <div className={ styles.more }>Подробнее</div>
      </div>
      <Calendar1 />
